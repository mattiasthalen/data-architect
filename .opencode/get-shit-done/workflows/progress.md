...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning --raw
```
...
- Count pending todos: `node ./.opencode/get-shit-done/bin/gsd-tools.js list-todos --raw`
