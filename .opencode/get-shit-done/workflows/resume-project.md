...
```bash
STATE_EXISTS=$(node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning/STATE.md --raw)
...
AGENT_FILE_EXISTS=$(node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning/current-agent-id.txt --raw)
