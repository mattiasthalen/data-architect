...
```bash
TODO_COUNT=$(node ./.opencode/get-shit-done/bin/gsd-tools.js list-todos --raw)
...
```bash
# Get todos JSON
node ./.opencode/get-shit-done/bin/gsd-tools.js list-todos [area]
```
...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning/ROADMAP.md --raw
```
...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.js list-todos --raw
```
