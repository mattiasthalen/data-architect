...
1. **Abort if project exists:**
   ```bash
   PROJECT_EXISTS=$(node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning/PROJECT.md --raw)
...
3. **Detect existing code (brownfield detection):**
   ...
   HAS_CODEBASE_MAP=$(node ./.opencode/get-shit-done/bin/gsd-tools.js verify-path-exists .planning/codebase --raw)
...
```bash
RESEARCHER_MODEL=$(node ./.opencode/get-shit-done/bin/gsd-tools.js resolve-model gsd-project-researcher --raw)
SYNTHESIZER_MODEL=$(node ./.opencode/get-shit-done/bin/gsd-tools.js resolve-model gsd-research-synthesizer --raw)
ROADMAPPER_MODEL=$(node ./.opencode/get-shit-done/bin/gsd-tools.js resolve-model gsd-roadmapper --raw)
```
